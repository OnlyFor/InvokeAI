...
export type AnyInvocation = Exclude<Graph['nodes'][string], { type: 'core_metadata' }>;
...
export type InvocationInputFields<T extends InvocationType> = Exclude<keyof Invocation<T>, NonInputFields>;
export type AnyInvocationInputField = Exclude<KeysOfUnion<AnyInvocation>, NonInputFields>;
